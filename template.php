 ...
 *   entirety and paste it here, changing the prefix from theme_ to copy_me_.
 *   For example:
 *
 *     original: theme_breadcrumb()
 *     theme override: copy_me_breadcrumb()
 *
 *   where copy_me is the name of your sub-theme. For example, the
